...
public class OpticInfo
{
  ...
  public static final Lens<OpticInfo, String> Accessor_Base = Accessor.andThen(AccessorInfo.Base);
  public static final Lens<OpticInfo, String> Accessor_UtilityClass = Accessor.andThen(AccessorInfo.UtilityClass);
  public static final Lens<OpticInfo, String> Accessor_Target = Accessor.andThen(AccessorInfo.Target);
